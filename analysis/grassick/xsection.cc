...
int main(){
  ...
  std::ifstream hepmc_is ("/data/atlas/atlasdata2/DiHiggsSharedSamples/arxiv-v1/SHERPA_QCD_2b2j.hepmc");      // HepMC input
  ...
  std::cout << "x_sec = " << tot_xsec << std::endl;
  std::cout << " sum_trials = " << sum_trls << std::endl;
  std::cout << "sum_weights = " << sum_wgts;
