...
double OxfordSidebandAnalysis::BoostedAnalysis( vector<PseudoJet> const& largeRJets, vector< vector<PseudoJet> > const& largeRsubJets, vector< vector<btagType> > btags, bool const& signal, double const& event_weight )
{
