...
// Small-R B-tagging
void OxfordSidebandAnalysis::BTagging( std::vector<fastjet::PseudoJet> const& jets_vec, std::vector<btagType>& btag_vec  )
{
  // Loop over all jets
...
void OxfordSidebandAnalysis::BTagging( std::vector<fastjet::PseudoJet> const& largeRJets,
...
void OxfordSidebandAnalysis::Reco_Resolved( std::vector<fastjet::PseudoJet> const& bjets, // Input b-jets
...
bool OxfordSidebandAnalysis::Reco_Intermediate(  std::vector<fastjet::PseudoJet> const& bjets, 
...
void OxfordSidebandAnalysis::JetFill(  std::vector<fastjet::PseudoJet> const& smallRJets,
...
void OxfordSidebandAnalysis::SubJetFill( std::vector<fastjet::PseudoJet> const& leading_subjet,
