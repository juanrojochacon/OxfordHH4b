...
# Output filename
outfile = "m_hh_res_comp_back"

linestyles = [ 'solid', 'dashed','solid', 'dashed']

# Datafiles
datafiles.append("../plotdata/results_SK_PU80/diHiggs/histo_m_HH_res_C1e.dat")
datafiles.append("../plotdata/results_SK_PU80/background/histo_m_HH_res_C1e.dat")
...
# Axis labels
xLabel = "Invariant mass of Di-Higgs (GeV)"
yLabel = "a. u."
...
fig.text(0.23,0.93,r"Resolved category,  $\langle n_{PU}\rangle =80$ + SK", fontsize=19)
