...
datafiles=[ "../plotdata/results_SK_PU80/MVA/nn_12X5X3X1_50000-Gen_SKPU80_res.dat",
            "../plotdata/results_noPU/MVA/nn_12X5X3X1_50000-Gen_noPU_res.dat"]

datanames=[ "SKPU80_Resolved","noPU_Resolved"]
...
# Histogram names
Histout = "disc_comp_res"  # Histograms for discriminant
ROCout = "roc_comp_res"	  # ROC curve
SBout = "sb_comp_res"	  # S/B curve
SSBout = "ssb_comp_res"	  # S/Sqrt(B) curve
NeVout = "nev_comp_res"	  # Number of events (twin axes)
NeV2out = "nev2_comp_res"  # Number of events (single axis)
