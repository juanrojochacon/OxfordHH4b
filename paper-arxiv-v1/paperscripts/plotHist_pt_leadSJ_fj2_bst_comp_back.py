...
# Output filename
outfile = "pt_leadSJ_fj2_bst_comp_back"

linestyles = [ 'solid', 'dashed','solid', 'dashed']

# Datafiles
datafiles.append("../plotdata/results_SK_PU80/diHiggs/histo_pt_leadSJ_fj2_boost_C1e.dat")
datafiles.append("../plotdata/results_SK_PU80/background/histo_pt_leadSJ_fj2_boost_C1e.dat")
...
# Axis labels
xLabel = "$p_T$ of Leading AKT03 SubJet in Sub-Leading Higgs Candidate (GeV)"
yLabel = "a. u."
