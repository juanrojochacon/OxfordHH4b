...
# Source files
datafiles=[ "../../paper-arxiv-v2/plotdata/baseline_noPU_oxford_hiStats/MVA/nn_14X5X3X1_50000-Gen_resNTuple_wSH.dat",
			"../../paper-arxiv-v2/plotdata/baseline_noPU_oxford_hiStats/MVA/nn_18X5X3X1_50000-Gen_intNTuple_wSH.dat",
			"../../paper-arxiv-v2/plotdata/baseline_noPU_oxford_hiStats/MVA/nn_22X5X3X1_50000-Gen_bstNTuple_wSH.dat"]
...
# Histogram names
Histout = "disc_noPU_hiStat"  # Histograms for discriminant
ROCout = "roc_noPU_hiStat"	  # ROC curve
SBout = "sb_noPU_hiStat"	  # S/B curve
SSBout = "ssb_noPU_hiStat"	  # S/Sqrt(B) curve
NeVout = "nev_noPU_hiStat"	  # Number of events (twin axes)
NeV2out = "nev2_noPU_hiStat"  # Number of events (single axis)

resc=1.1  #  to account for different total cross-section of QCD background samples
