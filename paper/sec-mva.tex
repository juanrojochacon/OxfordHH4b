...
presence of PU.
%
While as expected there is some degradation as compared to the case
without PU,
...
categories.
%
On the other hand, the intermediate category now becomes marginal.
%
...
these results  are reasonably stable in the case with PU.
...
\be
\lp \frac{S}{\sqrt{B}}\rp_{\rm tot} \simeq 4.0 \, ,\quad
\mathcal{L}=3\,{\rm ab}^{-1}\, .
\ee
%
...
should be 
well above the threshold for evidence, and even meeting the
...
instead
\be
\lp \frac{S}{\sqrt{B}}\rp_{\rm tot} \simeq 1.3(2.6) \, ,\quad
\mathcal{L}=300\,{\rm fb}^{-1}\, ,
\ee
