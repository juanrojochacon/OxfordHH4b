...
We now show how this signal significance
 ...
 is complemented by a multivariate analysis (MVA).
%
...
%
In particular, the classification of events into signal and
...
%
This family of ANNs are also known as {\it deep} neural networks, due to their multi-layered architecture.
%
...
the cross-entropy function, defined as
 ...
 To ensure that we include the variables with the most discriminating power,
 we need to train
 the MVA on a broad array of kinematic variables.
%
...
and intermediate categories), we are fully exploiting the available information 
on jet substructure.
