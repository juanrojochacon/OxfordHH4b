...
when the analysis is performed in a high-PU environment.
%
...
%
Once the MVA is applies, the signal significance in the three
categories is increased to 2.5, 1.1 and 2.9 respectively.
%
We also observe that, thanks
...
%
 We also quote the corresponding values of the signal 
    ...
    %
    The major improvement from eliminating the contamination
...
\begin{table}[h]
  ...
  \caption{\small Post-MVA number of background events
    ...
    component only, $N_{\rm ev}^{\rm 4b}$.
     %
    We also quote the values of the signal 
...
%
On the other hand, such measurement seems to be
