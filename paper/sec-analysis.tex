...
We will compare kinematic variables at each step of the analysis
for the boosted and for the resolved categories.
%
The corresponding plots for the intermediate category can be found in the webpage
mentioned above.
%
In the following comparisons, we compare related
kinematical distributions in the two categories.
...
of the
  leading and subleading large-$R$ jet in the boosted category, comparing
  the shapes of the distribution in signal and background events.
  %
  As we will do in all this section,
...
\caption{\small  The $p_T$ distribution of the
  ...
  subleading (right plot) large-$R$ jet in the boosted category.
  %
  We comparing
  the shapes of the distribution in signal and background events,
  where both
...
of the leading Higgs candidates, before the Higgs mass window
