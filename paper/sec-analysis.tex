...
a inclusive analysis, following which we introduce a
 prioritisation whereby events are assigned an exclusive category starting 
 with the category of highest signal significance.
...
%
Thie di-Higgs invariant mass is a direct measure of the boost of the system,
...
should provide additional discrimination power, motivating it's inclusion
...
We shall now investigate the discrimination power provided by jet substructure
quantities.
%
...
between QCD jets and jets originating from the Higgs decays.
%
...
modified in the presence of pile-up (PU).
%
