...
all for the leading
Higgs candidates, as we as also $\tau_{12}$ for the subleading
Higgs candidates.
...
%
Crucially, signal and background distributions peak
in rather
...
reasonably similar
for both the leading and in the subleading jets, therefore the information
contained in
this (and other substructure variables)
from each of the two Higgs candidates  will be to some
extent redundant.
