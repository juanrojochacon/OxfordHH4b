...
for some representative kinematic distributions.

\subsection{Jet reconstruction}

At the end of the  parton shower, final state particles
are clustered using the
jet reconstruction algorithms
are obtained from the
{\tt FastJet} program~\cite{Cacciari:2011ma,Cacciari:2005hq},
{\tt v3.1.0}.
%
In this study we will use different types of jet definitions,
...
\item {\it Small-$R$ jets}.
  ...
  and pseudo-rapidity $|\eta|<2.5$, within the central rapidity
...
\item {\it Large-$R$ jets}.
  ...
  satisfy  $p_T \ge 200$~GeV and lie in a pseudo-rapidity range of
  $|\eta|<2.0$.
  %
...
\item {\it Small-$R$ subjets}.
 ...
 %
  These small-$R$ subjets will be the building blocks of
...
%
The $b$-tagging strategy used in this feasibility study is inspired
...
\item {\it Small-$R$ jets}.
  ...
  \item {\it Large-$R$ jets}.
   ...
   $b$-quarks should satisfy $p_T \ge 15$ GeV.
    ...
    light jet  and charm jet mistag probabilities, there are taken
...
in this work we adopt as baseline the values $f_b=0.8$, $f_l=0.01$
and  $f_c=0.1$.
