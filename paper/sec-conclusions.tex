...
Efficiently triggering on the $4b$ final state provides a large experimental challenge.
%
In order to reduce the rate from background QCD processes sufficiently,
to access these $p_T$ regimes, (multi-)jet triggers
using $b$-quark tagging information online for one or more jets are likely to be important.
%
The additional rejection provided by this could enable events to be selected efficiently, with four jets down to $p_T=45$ GeV in the resolved category,
