...
%
First we present the results without considering PU,
followed by the corresponding analysis of the PU effect.
...
steps of the cut-flow of the present analysis,
separated into the boosted, intermediate,
    ...
    %
    In more details, these different analysis steps are the following:
...
\hline
  \end{tabular}
  \caption{\small Definition of the cut-flow steps for the boosted, intermediate
