...
# Output filename
outfile = "m_HH_C2_bst_comp"

linestyles = [ 'solid', 'dashed']

# Datafiles
datafiles.append("../plotdata/results_noPU/diHiggs/histo_m_HH_boost_C2.dat")
datafiles.append("../plotdata/results_SK_PU80/diHiggs/histo_m_HH_boost_C2.dat")
