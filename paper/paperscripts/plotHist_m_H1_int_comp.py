...
# Output filename
outfile = "m_H1_int_comp"

linestyles = [ 'solid', 'dashed']

# Datafiles
datafiles.append("../plotdata/results_noPU/diHiggs/histo_m_H1_inter_C2.dat")
datafiles.append("../plotdata/results_SK_PU80/diHiggs/histo_m_H1_inter_C2.dat")
...
fig.text(0.23,0.93,"Signal events, Intermediate category", fontsize=20)
