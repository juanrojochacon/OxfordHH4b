...
# Datafiles
datafiles.append("../plotdata/results_noPU/diHiggs/histo_C2_fj1_boost_C1e.dat")
datafiles.append("../plotdata/results_noPU/background/histo_C2_fj1_boost_C1e.dat")
...
# Axis labels
xLabel = r"ECF ratio $C_2^{(\beta)}$ in leading Higgs candidate"
yLabel = "a. u."
...
fig.text(0.28,0.93,r"Boosted category, $\langle n_{PU}\rangle=0$", fontsize=20)
