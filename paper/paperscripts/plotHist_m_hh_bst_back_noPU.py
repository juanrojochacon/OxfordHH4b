...
# Output filename
outfile = "m_hh_C2_res_back_noPU"

linestyles = [ 'solid', 'dashed','dotted']

# Datafiles
datafiles.append("../plotdata/results_noPU/SHERPA_QCD4b/histo_m_HH_res_C1e.dat")
datafiles.append("../plotdata/results_SK_PU80/SHERPA_QCD2b2j/histo_m_HH_res_C1e.dat")
