...
# Datafiles
datafiles.append("../plotdata/results_noPU/diHiggs/histo_m_H0_boost_C1d.dat")
datafiles.append("../plotdata/results_SK_PU80/diHiggs/histo_m_H0_boost_C1d.dat")


# Plot labels
plotnames.append("Signal - noPU")
plotnames.append("Signal - SK_PU80")

# Axis labels
xLabel = "Leading Higgs Invariant Mass (GeV)"
yLabel = "A. U."
