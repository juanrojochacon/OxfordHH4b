...
# Output filename
outfile = "pt_h0_res_comp_back"

linestyles = [ 'solid', 'dashed','solid', 'dashed']

# Datafiles
datafiles.append("../plotdata/results_noPU/diHiggs/histo_pt_H0_res_C1e.dat")
datafiles.append("../plotdata/results_SK_PU80/diHiggs/histo_pt_H0_res_C1e.dat")
datafiles.append("../plotdata/results_noPU/background/histo_pt_H0_res_C1e.dat")
datafiles.append("../plotdata/results_SK_PU80/background/histo_pt_H0_res_C1e.dat")
