...
# Output filename
outfile = "split12_h0_bst_comp_back"

linestyles = [ 'solid', 'dashed','solid', 'dashed']

# Datafiles
datafiles.append("../plotdata/results_noPU/diHiggs/histo_split12_fj1_boost_C1e.dat")
datafiles.append("../plotdata/results_SK_PU80/diHiggs/histo_split12_fj1_boost_C1e.dat")
datafiles.append("../plotdata/results_noPU/background/histo_split12_fj1_boost_C1e.dat")
datafiles.append("../plotdata/results_SK_PU80/background/histo_split12_fj1_boost_C1e.dat")
...
# Axis labels
xLabel = r"$k_T$ splitting scale $\sqrt{d_{12}}$ in leading Higgs candidate (GeV)"
yLabel = "a. u."
