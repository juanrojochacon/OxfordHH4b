...
# Output filename
outfile = "pt_HH_C1d_bst_noPU"

linestyles = [ 'solid', 'dashed']

# Datafiles
datafiles.append("../plotdata/results_noPU/diHiggs/histo_pt_HH_boost_C1d.dat")
datafiles.append("../plotdata/results_noPU/background/histo_pt_HH_boost_C1d.dat")
