...
# Output filename
outfile = "pt_h0_C2_bst_back_noPU"

linestyles = [ 'solid', 'dashed','dotted']

# Datafiles
datafiles.append("../plotdata/results_noPU/SHERPA_QCD4b/histo_pt_H0_boost_C1e.dat")
datafiles.append("../plotdata/results_SK_PU80/SHERPA_QCD2b2j/histo_pt_H0_boost_C1e.dat")
