...
\abstract{
  ...
  symmetry breaking mechanism due to its sensitivity
  ...
  jet mistags that is found to be comparable
  to the irreducible $4b$ QCD background.
  %
  We demonstrate the robustness of our analysis in a high pile-up
  environment.
  %
  For an integrated luminosity of $\mathcal{L}=3$ ab$^{-1}$,
  an overall signal significance of  $S/\sqrt{B}\simeq 4$ is obtained.
  %
