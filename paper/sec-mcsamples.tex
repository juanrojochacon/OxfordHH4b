...
In addition, to account for the finite angular resolution of the calorimeter,
...
the reconstructed Higgs candidates of around 10 GeV, consistent
...
invariant Higgs mass distributions of 
in signal events, we can 
determine the effective mass resolution
in the present analysis.
%
We find a resolution of about 8\% in the resolved
category, corresponding to a window
of around 10 GeV for $m_h=125$ GeV.
%
Fitting the Higgs    mass distributions 
in the case of $\la n_{\rm PU}\ra=80$ PU events
with subtraction
(see Sect.~\ref{sec:pileup}),
the mass resolution is degraded down to
    around 11\%, corresponding to a windown of
    14 GeV around the Higgs mass.
    %
