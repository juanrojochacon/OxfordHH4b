...
# Output filename
outfile = "pt_HH_res_C1"

linestyles = [ 'solid', 'dashed']

# Datafiles
datafiles.append("../plotdata/oxford_combined_rw/signal/histo_pt_HH_res_C1.dat")
datafiles.append("../plotdata/oxford_combined_rw/background/histo_pt_HH_res_C1.dat")
