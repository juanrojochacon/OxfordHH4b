...
# Output filename
outfile = "m_H0_res_C1_boost"

# Datafiles
datafiles.append("../plotdata/oxford_combined_rw/signal/histo_m_H0_inter_C1.dat")
datafiles.append("../plotdata/oxford_combined_rw/background/histo_m_H0_inter_C1.dat")
...
# Axis labels
xLabel = "Leading Higgs candiate $m_h$ (GeV)"
yLabel = "A. U."
