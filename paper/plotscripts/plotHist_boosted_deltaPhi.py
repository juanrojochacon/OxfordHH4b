...
# Output filename
outfile = "DeltaPhi_HH_C1_boosted"


linestyles = [ 'solid', 'dashed']

# Datafiles
datafiles.append("../plotdata/oxford_combined_rw/signal/histo_dPhi_HH_boost_C1.dat")
datafiles.append("../plotdata/oxford_combined_rw/background/histo_dPhi_HH_boost_C1.dat")
