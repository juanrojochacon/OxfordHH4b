...
# Output filename
outfile = "split12_h0_bst_comp"

linestyles = [ 'solid', 'dashed']

# Datafiles
datafiles.append("../plotdata/results_noPU/diHiggs/histo_split12_fj1_boost_C2.dat")
datafiles.append("../plotdata/results_SK_PU80/diHiggs/histo_split12_fj1_boost_C2.dat")
...
# Axis labels
xLabel = r"$k_T$ splitting scale $\sqrt{d_{12}}$ for leading Higgs candidate (GeV)"
yLabel = "a. u."
