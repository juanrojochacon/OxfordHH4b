...
# Output filename
outfile = "pt_leadSJ_fj1_bst_comp"

linestyles = [ 'solid', 'dashed']

# Datafiles
datafiles.append("../plotdata/results_noPU/diHiggs/histo_pt_leadSJ_fj1_boost_C2.dat")
datafiles.append("../plotdata/results_SK_PU80/diHiggs/histo_pt_leadSJ_fj1_boost_C2.dat")
...
# Axis labels
xLabel = "$p_{T}$ of Leading AKT03 Subjet in Leading Higgs Candidate (GeV)"
yLabel = "A. U."
