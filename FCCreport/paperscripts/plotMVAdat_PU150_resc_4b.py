...
# Histogram names
Histout = "disc_SKPU150_4b"  # Histograms for discriminant
ROCout = "roc_SKPU150_4b"	  # ROC curve
SBout = "sb_SKPU150_4b"	  # S/B curve
SSBout = "ssb_SKPU150_4b"	  # S/Sqrt(B) curve
NeVout = "nev_SKPU150_4b"	  # Number of events (twin axes)
NeV2out = "nev2_SKPU150_4b"  # Number of events (single axis)
...
sb.text(0.35,0.94,r"HL-LHC, $\langle n_{PU}\rangle =150$+SK", fontsize=20)
sb.savefig(SBout+'.pdf')

ssb.text(0.35,0.94,r"HL-LHC, $\langle n_{PU}\rangle =150$+SK", fontsize=20)
ssb.savefig(SSBout+'.pdf')

nev3.text(0.34,0.94,r"HL-LHC, $\langle n_{PU}\rangle =150$+SK", fontsize=20)
