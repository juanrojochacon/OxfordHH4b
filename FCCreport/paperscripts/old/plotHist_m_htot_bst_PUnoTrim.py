...
# Output filename
outfile = "m_htot_bst_signal_PUnoTrim"

linestyles = [ 'solid', 'dashed','dotted', 'dashed']

# Datafiles
datafiles.append("../plotdata/results_noPU/diHiggs/histo_m_H0_boost_C1e.dat")
datafiles.append("../plotdata/results_SK_PU80/diHiggs/histo_m_H0_boost_C1e.dat")
datafiles.append("../plotdata/results_SK_PU80_noTrim/diHiggs/histo_m_H0_boost_C1e.dat")
...
fig.text(0.21,0.93,"Signal events, Boosted category", fontsize=20)
