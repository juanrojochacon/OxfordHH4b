...
# Output filename
outfile = "pt_H0_sub0_res_noPU_ANNcut_back_4b"

linestyles = [ 'solid', 'dashed']

# Datafiles
datafiles.append("histo_pt_H0_sub0_y00_back4b.dat")
datafiles.append("histo_pt_H0_sub0_y06_back4b.dat")
...
fig.text(0.18,0.93,r"QCD $4b$ events, resolved category, no PU", fontsize=18)
