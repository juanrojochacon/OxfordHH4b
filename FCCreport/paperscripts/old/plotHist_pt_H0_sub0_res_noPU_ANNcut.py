...
# Output filename
outfile = "pt_H0_sub0_res_noPU_ANNcut"

linestyles = [ 'solid', 'dashed']

# Datafiles
datafiles.append("histo_pt_H0_sub0_y00_sig1.dat")
datafiles.append("histo_pt_H0_sub0_y06_sig1.dat")

# Plot labels
plotnames.append(r"pre-MVA, $y_{cut}=0.0$")
plotnames.append(r"post-MVA, $y_{cut}=0.6$")

# Axis labels
xLabel = r"Leading AKT04 $b$-jet $p_T$ (GeV)"
yLabel = "a. u."
...
fig.text(0.18,0.93,r"Signal events, resolved category, no PU", fontsize=18)
