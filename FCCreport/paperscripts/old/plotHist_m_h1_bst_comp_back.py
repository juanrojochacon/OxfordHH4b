...
# Output filename
outfile = "m_h1_bst_comp_back"

linestyles = [ 'solid', 'dashed','solid', 'dashed']

# Datafiles
datafiles.append("../plotdata/results_SK_PU80/diHiggs/histo_m_H1_boost_C1e.dat")
datafiles.append("../plotdata/results_SK_PU80/background/histo_m_H1_boost_C1e.dat")
