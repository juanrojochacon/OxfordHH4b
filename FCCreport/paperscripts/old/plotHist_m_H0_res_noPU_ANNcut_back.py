...
# Output filename
outfile = "m_H0_res_noPU_ANNcut_back"

linestyles = [ 'solid', 'dashed']

# Datafiles
datafiles.append("histo_m_H0_y00_sig0.dat")
datafiles.append("histo_m_H0_y06_sig0.dat")
...
fig.text(0.14,0.93,r"Background events, resolved category, no PU", fontsize=18)
