...
# Output filename
outfile = "pt_H0_sub0_res_noPU_ANNcut_back"

linestyles = [ 'solid', 'dashed']

# Datafiles
datafiles.append("histo_pt_H0_sub0_y00_sig0.dat")
datafiles.append("histo_pt_H0_sub0_y06_sig0.dat")
...
fig.text(0.16,0.93,r"Background events, resolved category, no PU", fontsize=18)
