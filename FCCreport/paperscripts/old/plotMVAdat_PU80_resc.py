...
titlenames=[ r"Resolved Category,  $ n_{PU} =80$+SK",
             r"Intermediate Category,  $ n_{PU} =80$+SK",\
             r"Boosted Category,  $ n_{PU}=80$+SK"]
...
roc.text(0.29,0.94,r"HL-LHC, PU80+SK+Trim", fontsize=20)
roc.savefig(ROCout+'.pdf')

sb.text(0.29,0.94,r"HL-LHC, PU80+SK+Trim", fontsize=20)
sb.savefig(SBout+'.pdf')

ssb.text(0.29,0.94,r"HL-LHC, PU80+SK+Trim", fontsize=20)
ssb.savefig(SSBout+'.pdf')

nev3.text(0.29,0.94,r"HL-LHC, PU80+SK+Trim", fontsize=20)
