...
# Output filename
outfile = "m_H0_int_comp"

linestyles = [ 'solid', 'dashed']

# Datafiles
datafiles.append("../plotdata/results_noPU/diHiggs/histo_m_H0_inter_C2.dat")
datafiles.append("../plotdata/results_SK_PU80/diHiggs/histo_m_H0_inter_C2.dat")
