...
titlenames=[ r"Resolved Category,  $\langle n_{PU}\rangle =150$+SK",
             r"Intermediate Category,  $\langle n_{PU}\rangle =150$+SK",\
             r"Boosted Category,  $\langle n_{PU}\rangle=150$+SK"]
...
# Histogram names
Histout = "disc_SKPU150"  # Histograms for discriminant
ROCout = "roc_SKPU8150"	  # ROC curve
SBout = "sb_SKPU150"	  # S/B curve
SSBout = "ssb_SKPU150"	  # S/Sqrt(B) curve
NeVout = "nev_SKPU150"	  # Number of events (twin axes)
NeV2out = "nev2_SKPU150"  # Number of events (single axis)
...
roc.text(0.28,0.94,r"HL-LHC, $\langle n_{PU}\rangle =150$+SK+Trim", fontsize=20)
roc.savefig(ROCout+'.pdf')

sb.text(0.28,0.94,r"HL-LHC, $\langle n_{PU}\rangle =150$+SK+Trim", fontsize=20)
sb.savefig(SBout+'.pdf')

ssb.text(0.28,0.94,r"HL-LHC, $\langle n_{PU}\rangle =150$+SK+Trim", fontsize=20)
ssb.savefig(SSBout+'.pdf')

nev3.text(0.28,0.94,r"HL-LHC, $\langle n_{PU}\rangle =150$+SK+Trim", fontsize=20)
