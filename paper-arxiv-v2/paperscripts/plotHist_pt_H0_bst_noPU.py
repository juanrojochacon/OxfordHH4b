...
# Output filename
outfile = "pt_H0_bst_C1d_noPU"

linestyles = [ 'solid', 'dashed']

# Datafiles
datafiles.append("../plotdata/results_noPU/diHiggs/histo_pt_H0_boost_C1d.dat")
datafiles.append("../plotdata/results_noPU/background/histo_pt_H0_boost_C1d.dat")
...
# Axis labels
xLabel = "Leading Higgs Candidate $p^{h}_T$ (GeV)"
yLabel = "a. u."
...
fig.text(0.25,0.93,r"Boosted category, no PU", fontsize=20)
