...
# Init data
datafile = '../plotdata/results_noPU/MVA/nn_17X5X3X1_50000-Gen_noPU_int.net'
dataname = "Intermediate"
sourcefile = os.path.expanduser(datafile)

archout = "int_nnarch_noPU"
histout = "int_wgthist_noPU"
...
plt.text(5,9.5,"Intermediate category, no PU", fontsize=20)
