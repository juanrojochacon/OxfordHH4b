...
# Output filename
outfile = "C2_h0_bst_comp_back"

linestyles = [ 'solid', 'dashed','solid', 'dashed']

# Datafiles
datafiles.append("../plotdata/results_SK_PU80/diHiggs/histo_C2_fj1_boost_C1e.dat")
datafiles.append("../plotdata/results_SK_PU80/background/histo_C2_fj1_boost_C1e.dat")
...
# Axis labels
xLabel = r"ECF ratio $C_{2}^{(\beta)}$ in leading Higgs candidate"
yLabel = "a. u."
